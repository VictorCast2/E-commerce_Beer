...
class CategoriaControllerTest {
    ...
    void categoria() throws Exception {
        ...
        List<CategoriaResponse> categoriasMock = List.of(
    ...
    void addcategoria() throws Exception {
        ...
        // Then
        mockMvc.perform(post("/admin/Categoria/addCategoria")
                        .with(csrf())
    ...
    void updateCategoria() throws Exception {
        ...
        // Then
        mockMvc.perform(post("/admin/Categoria/updateCategoria/{id}", id)
                        .with(csrf())
    ...
    void disableCategoria() throws Exception {
        ...
        // Then
        mockMvc.perform(post("/admin/Categoria/disableCategoria/{id}", id)
                        .with(csrf()))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/admin/Categoria/?mensaje=" + mensajeEncode));
    ...
    void deleteCategoria() throws Exception {
        ...
        // Then
        mockMvc.perform(post("/admin/Categoria/deleteCategoria/{id}", id)
                .with(csrf()))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/admin/Categoria/?mensaje=" + mensajeEncode));
